...
% Define bullet style
\setlist[itemize]{label=\textbullet, itemsep=0.5\baselineskip, parsep=0.5\baselineskip}
...
\begin{itemize}[leftmargin=1.5em, itemsep=0.5\baselineskip, parsep=0.5\baselineskip]
